...
options = ["./new_ising.exe", "-x", str(Nx), "-y", str(Ny), "--temp", str(temp), "--dist", str(distType), "--therm", str(Ntherm), "--time", str(Nmc), "--autocorr", str(tmax), "--autocorr-dt", str(dt), "--bin-size", str(bin_size)]
